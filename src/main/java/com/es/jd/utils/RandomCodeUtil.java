...
public class RandomCodeUtil {
    ...
    public static void main(String[] args) {
    	//根据性别生成2-5位的随机名字   sex 性别      0：女生，1：男生
//		String str = RandomCodeUtil.getRandomChinese("0");
    	
    	//生成指定长度的数字随机数
    	String str = RandomCodeUtil.getRandNumberCode(8);
    	
    	//生成指定长度的数字随机数,不能以0开头
    	//String str = RandomCodeUtil.getRandNumber(8);
  
    	//生成指定长度的字母随机数
    	//String str = RandomCodeUtil.getRandEnglishCode(5);
    	
    	//生成相应长度的数字字母组合的随机数
    	//String str = RandomCodeUtil.getRandStrCode(8);
        for (int i = 0; i < 50; i++) {

            System.out.println(getRandNumberCode(8));
        }
	}
}